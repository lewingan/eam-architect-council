...
3. **Industry best practice** -- Where SAP has no native capability, defer to the general EAM expert's industry-standard recommendation.
4. **Simplicity** -- Between two otherwise-equal approaches, prefer the simpler one with fewer integration points.
